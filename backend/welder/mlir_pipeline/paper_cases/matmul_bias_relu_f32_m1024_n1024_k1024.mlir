// 用例：MatMul + Bias(Add) + ReLU（f32）
//
// 说明：
// - 为简化起见，Bias 建模为完整 [M,N] 张量（不做 broadcast）。
// - 这对应 MLP/FC 层中非常常见的 epilogue 模式。
//
...
module {
  func.func @main(
      ...
      %Bias: tensor<1024x1024xf32>) -> tensor<1024x1024xf32> {
    ...
    } ins(%C, %Bias : tensor<1024x1024xf32>, tensor<1024x1024xf32>)
